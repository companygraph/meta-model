...
// The four entities an instance cannot pass without: every singular type must have its file,
// and every `source` reference must resolve, so the source those three name is written too. Each
