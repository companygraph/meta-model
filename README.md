...
example/           a fictional company, described in those thirteen types
...
core types still ahead. The current release is 0.23.0, the twenty-seventh tag, and at that release
...
strategy and role. The reference instance,
