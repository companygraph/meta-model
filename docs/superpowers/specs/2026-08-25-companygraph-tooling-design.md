...
Status: design agreed, nothing built. This spec lives here because the `tooling` repository does not exist yet. When it does, the spec moves with it and this file becomes a link.
